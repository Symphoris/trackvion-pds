...
public class UseBlindsInsert {
	
	public int ourUpdate;
	public int id;
		
		public UseBlindsInsert(int ourUpdate, int id) {
		...
		public boolean executeInscription() {
			...
			try {
				...
				PreparedStatement stmt2 = connection.prepareStatement("UPDATE Objects SET State_Object = ? WHERE ID_Apartment = ? AND Type_Object ='Blind';");
